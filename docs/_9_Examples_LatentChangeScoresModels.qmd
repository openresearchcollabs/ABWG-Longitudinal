...
model <- '
    ...
    delta12 =~ 0*anthroheightcalc_1
    delta23 =~ 0*anthroheightcalc_2

    anthroheightcalc_1 ~ 1*anthroheightcalc_0 + delta12
    anthroheightcalc_2 ~ 1*anthroheightcalc_1 + delta23
...
```{r, eval = FALSE}
# Fit the model
fit <- sem(lcs.model, data = df_wide, missing = "FIML")
