...
[**Each Tutorial**]{style="color: goldenrod; font-size: 1.2em; font-family: Verdana, sans-serif;"} is a self-contained introductory and step-by-step guide for a specific longitudinal analysis method. Tutorials are based on generic (simulated) data in order to provide accessible entry-level examples that enable users to develop their skills and basic understanding of a specific type of analysis.
:::
:::
      ...
      <div class="our_solution_category">
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <a href="./Tutorials.qmd">
              <p>
                For code examples that use ABCD Study data
              </p>
	...
	<div class="container py-2">
			...
			<div class="postcard__text t-dark">
				...
				<ul class="postcard__tagbox">
					<li class="tag__item play blue">
						<a href="./1_Tutorials_DifferenceScores.qmd"><i class="fas fa-play mr-2"></i>Difference Scores</a>
						</li>
					<li class="tag__item play blue">
						<a href="./2_Tutorials_ResidualizedChangeScores.qmd"><i class="fas fa-play mr-2"></i>Residualized Change Scores</a>
						</li>
					<li class="tag__item play blue">
						<a href="./3_Tutorials_LinearMixedModels.qmd"><i class="fas fa-play mr-2"></i>Linear Mixed Models</a>
					</li>
				</ul>
			</div>
		</article>
		<article class="postcard light red">
			...
			<div class="postcard__text t-dark">
				...
				<ul class="postcard__tagbox">
				  <li class="tag__item play blue">
						<a href="./4_Tutorials_SignedRankTest.qmd"><i class="fas fa-play mr-2"></i>Signed-Rank
						Test</a>
						</li>
					<li class="tag__item play blue">
						<a href="./5_Tutorials_MarginalModels.qmd"><i class="fas fa-play mr-2"></i>Marginal Models</a>
						</li>
						<li class="tag__item play blue">
						<a href="./6_Tutorials_GeneralizedEstimatingEquations.qmd"><i class="fas fa-play
						mr-2"></i>Generalized
						Estimating Equations</a>
						</li>
						<li class="tag__item play blue">
						<a href="./7_Tutorials_GeneralizedLinearMixedEffectsModels.qmd"><i class="fas fa-play
		...
		<article class="postcard light red">
			...
			<div class="postcard__text t-dark">
				...
				<ul class="postcard__tagbox">
				  <li class="tag__item play blue">
						<a href="./9_Tutorials_LatentChangeScoresModels.qmd"><i class="fas fa-play
						mr-2"></i>Latent Change Score Models</a>
						</li>
					<li class="tag__item play blue">
						<a href="./10_Tutorials_LatentGrowthCurveModels.qmd"><i class="fas fa-play
						mr-2"></i>Latent Growth Curve Models</a>
						</li>
					<li class="tag__item play blue">
						<a href=""><i class="fas fa-play
		...
		<article class="postcard light red">
			...
			<div class="postcard__text t-dark">
				...
				<ul class="postcard__tagbox">
				  <li class="tag__item play blue">
						<a href="./15_Tutorials_RandomInterceptCrosslaggedPanelModels.qmd"><i class="fas fa-play
						mr-2"></i>Random-Intercept Crosslagged Panel Model</a>
						</li>
						<li class="tag__item play blue">
						<a href="./16_Tutorials_LatentCurveModelsStructuredResiduals.qmd"><i class="fas fa-play
...
::: {.callout-note collapse="true" title="Add Title"}
## Expand To Learn About the Divio Documentation Style Used on this Site
